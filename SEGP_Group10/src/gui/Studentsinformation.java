...
public class Studentsinformation implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        JFXTreeTableColumn<gui.Studentsinformation.Student, String> studentUOB = new JFXTreeTableColumn<>("UOB");
        studentUOB.setPrefWidth(100);
        studentUOB.setCellValueFactory(new Callback<TreeTableColumn.CellDataFeatures<gui.Studentsinformation.Student, String>, ObservableValue<String>>() {

            @Override
            public ObservableValue<String> call(TreeTableColumn.CellDataFeatures<gui.Studentsinformation.Student, String> param) {
                return param.getValue().getValue().studentUOB;
            }
        });

        JFXTreeTableColumn<gui.Studentsinformation.Student, String> studentName = new JFXTreeTableColumn<>("Name");
        studentName.setPrefWidth(150);
        studentName.setCellValueFactory(new Callback<TreeTableColumn.CellDataFeatures<gui.Studentsinformation.Student, String>, ObservableValue<String>>() {
        ...
        JFXTreeTableColumn<Studentsinformation.Student, String> dept = new JFXTreeTableColumn<>("Dept");
